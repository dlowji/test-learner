...
"""
learner-pathway-progress documentation build configuration file.
...
#
# html_title = 'learner-pathway-progress v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'A plugin to track learners progress in pathways.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'learner_pathway_progress'),
                os.path.join(root_path, 'learner_pathway_progress/migrations')])
